...
import frc.robot.paths.CenterShieldGeneratorPath;
...
public class CenterShieldGeneratorAuto extends SequentialCommandGroup {

  public CenterShieldGeneratorAuto(Shooter shooter, AdjustabeHood adjustabeHood, DriveTrain driveTrain, Spindexer spindexer, Ejector ejector, Intake intake) {
    ...
    addCommands(
      ...
      new ParallelRaceGroup(
        ...
        new SequentialCommandGroup(
          ...
          new SetShooterSpeed(shooter, 4300),
          new ParallelRaceGroup(
            new AutoFollowPath(driveTrain, new CenterShieldGeneratorPath(driveTrain).generateSwerveTrajectory()),
